...
base_dir = '/content/drive/MyDrive/ColabNotebooks/dataset'
...
def create_data_generators(train_images, val_images, test_images, image_size=(224, 224), batch_size=32):
...
class CustomCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        if epoch + 1 == self.ask_epoch:
            ...
            if user_input.lower() != 'yes' or 'y' or 'Yes' or 'Y' or 'YES':
...
#Confusion Matrix (Not tested yet)

# prompt: generate a confuse matrix function
